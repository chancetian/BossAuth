  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch">
       <el-form-item label="应用系统" prop="appCode">
          <el-select v-model="queryParams.appCode" placeholder="请选择系统" @change="getList()">
                    <el-option
    ...
    >
      ...
      <el-table-column prop="authorize" label="权限标识" :show-overflow-tooltip="true"></el-table-column>
      <el-table-column prop="menuUrl" label="组件路径" :show-overflow-tooltip="true"></el-table-column>
    ...
    <el-dialog :title="title" :visible.sync="open" width="680px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="100px">
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item>
              <el-input v-model="form.authorize" placeholder="请输入权限标识" maxlength="100" />
              <span slot="label">
