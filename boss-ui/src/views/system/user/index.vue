  ...
  <div class="app-container">
    <el-row :gutter="20">
      ...
      <el-col :span="20" :xs="24">
        ...
        <el-table v-loading="loading" :data="userList" @selection-change="handleSelectionChange">
          ...
          <el-table-column label="部门" align="center" key="departmentName" prop="departmentName" v-if="columns[3].visible" :show-overflow-tooltip="true" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="600px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item v-if="form.id == 0" label="用户名称" prop="userName">
              <el-input v-model="form.userName" placeholder="请输入用户名称" maxlength="30" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item v-if="form.id == 0" label="用户密码" prop="password">
...
export default {
  ...
  methods: {
    ...
    /** 查询角色列表 */
    getRoleList() {
      listRole({pageNum: 1, pageSize: 1000, params: {}}).then(response => {
     ...
     /** 查询岗位列表 */
    getPostList() {
      listPost({pageNum: 1, pageSize: 1000, params: {}}).then(response => {
    ...
    importTemplate() {
      ...
      window.location.href=process.env.VUE_APP_BASE_API.replace('api','')+'/template/import_user_template.xlsx';
